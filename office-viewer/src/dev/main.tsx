...
function requireElement<T extends HTMLElement>(
    ...
    if (!element) {
        throw new Error(
            `Required development element "${selector}" was not found.`
        );
    }
